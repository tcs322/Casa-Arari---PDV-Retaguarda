            ...
            @if(auth()->check() && auth()->user()->isAdmin())
                <li style="font-size: 13px">
                    ...
                    <ul id="dropdown-estrutura-organizacional" class="hidden py-2 space-y-2" style="font-size: 13px">
                        ...
                        <li>
                            <a href="{{route('nota.index')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Notas</a>
                        </li>
                    </ul>
                </li>
            @endif
